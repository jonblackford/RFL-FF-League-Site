...
const pages = [
  {
    path: "",
    title: "Fantasy Football Team & League Analyzer | RFL Agent",
    description:
  ...
  },
  {
    ...
    heading: "About RFL Agent",
    introduction:
      "RFL Agent makes fantasy football leagues easier to follow with stats, charts, recaps, and awards that bring each season’s story to life.",
    sections: [
  ...
  },
  {
    ...
    heading: "RFL Agent changelog",
    introduction:
      "Follow the latest RFL Agent features, product updates, and fixes for fantasy football league analysis, reports, manager profiles, trades, and more.",
    sections: [
  ...
  },
  {
    ...
    introduction:
      "Learn what information RFL Agent processes, how it is used, which service providers support the product, and what choices are available to you.",
    ctaLabel: "Return to RFL Agent",
    sections: [
      {
        title: "Account and league data",
        body: "RFL Agent processes account details and the Sleeper or ESPN league information needed to provide league analysis, reports, manager profiles, and video recaps.",
      },
      {
      ...
      {
        title: "Your choices",
        body: "You can clear browser-stored league data and contact RFL Agent to request access to, correction of, or deletion of account information, subject to legal and operational requirements.",
      },
    ],
  },
  {
    ...
    introduction:
      "Review the terms that apply to RFL Agent accounts, league data, paid plans, generated reports and videos, sharing, and acceptable use.",
    ctaLabel: "Return to RFL Agent",
    sections: [
      {
        title: "Using the service",
        body: "RFL Agent provides fantasy football analysis, reports, generated videos, sharing tools, and related free and paid features.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question: "Does RFL Agent support dynasty and redraft leagues?",
        answer:
          "RFL Agent supports Sleeper NFL leagues across common redraft, keeper, and dynasty setups, subject to the data available for that league.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "Open the league in ESPN and use the number following leagueId= in the page URL, then select the matching season in RFL Agent.",
      },
      {
        question: "Can RFL Agent analyze a private ESPN league?",
        answer:
    ...
    faqs: [
      {
        ...
        answer:
          "RFL Agent loads completed draft data from connected Sleeper and ESPN fantasy football leagues when that draft data is available.",
      },
      {
      ...
      {
        question: "Can RFL Agent grade my fantasy football team?",
        answer:
          "Yes. After a supported Sleeper or ESPN draft is complete, RFL Agent grades the individual picks and the drafted team relative to the rest of that league’s draft room.",
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "RFL Agent normalizes league data and calculates the underlying matchup and lineup facts before AI turns the structured context into a report.",
      },
    ],
    faqs: [
      {
        ...
        answer:
          "RFL Agent supports Sleeper and ESPN fantasy football leagues. Sleeper leagues can be added by league ID or username, while ESPN leagues can be imported through the ESPN flow in the app.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "The Standard weekly report and the core RFL Agent league-analysis experience are free. Premium adds the longer newspaper-style report, deeper manager context, customizable commentary, selectable shared-report insights, and video options.",
      },
      {
  ...
  },
  {
    ...
    structuredData: {
      ...
      mainEntityOfPage:
        "/fantasy-football-weekly-recap-example",
      author: {
        "@type": "Organization",
        name: "RFL Agent",
        url: "/",
  ...
  },
  {
    ...
    ogVideo: "/video/ffwrapped-marketing-demo-week-11.mp4",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "VideoObject",
      ...
      duration: "PT40S",
      contentUrl:
        "/video/ffwrapped-marketing-demo-week-11.mp4",
      embedUrl: "/fantasy-football-video-recap-example",
...
for (const page of pages) {
  ...
  const videoMeta = page.ogVideo
    ...
    : "";
  const imageUrl = page.ogImage ?? "./logo.webp";
  const html = template
    .replace(
      /<title>[^<]*<\/title>/,
