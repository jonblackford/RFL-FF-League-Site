...
const faqs = [
  ...
  {
    question: "How does RFL Agent decide whether a trade is balanced?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Trade Finder works with supported Sleeper and ESPN fantasy football leagues after their roster and scoring data have been imported into RFL Agent.",
  },
  {
