...
<template>
  <PageContainer>
      ...
      <div class="max-w-4xl text-base leading-relaxed">
        ...
        By accessing or using RFL Agent ("Service"), you agree to be bound by
        ...
        RFL Agent provides fantasy football analysis, reports, generated video
        recaps, sharing tools, and related features. Some features are free and
        some are available only with a paid plan. RFL Agent is an independent
        ...
        the Service. You grant RFL Agent a limited, non-exclusive license to
        ...
        your RFL Agent account does not automatically cancel a recurring
        ...
        RFL Agent or its licensors and is protected by applicable law. You may
        ...
        No permission is granted to use RFL Agent names, logos, or other
        ...
        To the maximum extent permitted by law, RFL Agent and its operators are
        ...
        You agree to defend, indemnify, and hold harmless RFL Agent and its
        ...
        between you and RFL Agent regarding the Service. If any provision is
        ...
        If you have questions about these Terms, contact the person or group
        hosting your RFL Agent instance. <br /><br />
