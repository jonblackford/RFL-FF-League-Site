    ...
    content: [
      {
        type: "Feature",
        text: [
          "There is now a trade database in the trade lab tab. All trades from RFL Agent leagues will be searchable.",
        ],
      },
    ],
  },
...
<template>
  <PageContainer>
    ...
    <div class="max-w-lg mb-6">
      <p>
        Product notes for this RFL Agent instance, including feature updates,
        fixes, and analysis improvements.
      </p>
    </div>
