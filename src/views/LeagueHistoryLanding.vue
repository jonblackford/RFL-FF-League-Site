...
const faqs = [
  {
    ...
    answer:
      "RFL Agent combines available seasons into all-time standings, season finishes, championships, head-to-head matchup records, scoring highs and lows, close games, blowouts, expected-win luck, and manager efficiency.",
  },
  {
  ...
  <PublicPageShell>
    ...
    >
      <div>
        ...
        <p class="mt-4 leading-7 text-muted-foreground">
          RFL Agent walks through the available league seasons and compiles
