...
<template>
  <PageContainer>
      ...
      <div class="max-w-4xl text-base leading-relaxed">
        ...
        RFL Agent ("we," "our," or "us") is committed to protecting your
        privacy. This Privacy Policy explains how information is processed when
        you use a hosted RFL Agent instance.
        <p class="my-3 text-xl font-semibold">Information Collection and Use</p>
        You can browse most of RFL Agent without creating an account. If you
        ...
        URL is not displayed to other RFL Agent users, but anyone who obtains
        ...
        available after the RFL Agent-hosted copy is deleted.
        ...
        We do not store full payment card details on RFL Agent. We may store
        ...
        subscription-status data on your device. RFL Agent does not directly
        set cookies. Third-party websites or services you visit through
        RFL Agent, such as authentication, billing, or fantasy football
        ...
        may associate PostHog analytics with your RFL Agent user ID, email
        ...
        the person or group hosting your RFL Agent instance.
      </div>
  </PageContainer>
</template>
