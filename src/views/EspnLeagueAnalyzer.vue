...
const connectionPaths = [
  ...
  },
  {
    ...
    description:
      "Use the guided credential steps while signed in to ESPN. Credentials are stored locally in your browser and sent through RFL Agent only when loading that league from ESPN.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Open the league in ESPN and look for the number following leagueId= in the page URL. Select the matching season in RFL Agent before importing.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "RFL Agent stores them locally in the browser and only sends them through its service to ESPN when loading the private league. They should be treated like a password.",
  },
  {
    question: "Does the ESPN analyzer replace the ESPN app?",
    answer:
      "No. ESPN remains the league platform. RFL Agent adds analysis, simulations, history views, and reports around the imported league data.",
  },
  {
    ...
    >
      <div>
        ...
        <p class="mt-4 leading-7 text-muted-foreground">
          The import supplies the facts RFL Agent needs to understand the league
          on its own terms.
        </p>
