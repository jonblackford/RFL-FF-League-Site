...
const faqs = [
  {
    ...
    answer:
      "RFL Agent follows the available season history for a connected Sleeper or ESPN league. The exact depth depends on the platform data and linked seasons available for that league.",
  },
  {
