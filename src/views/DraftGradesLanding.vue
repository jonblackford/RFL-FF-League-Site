...
const methodology = [
  {
    ...
    description:
      "RFL Agent imports completed picks, draft slots, league format, scoring type, and roster ownership from the connected league.",
  },
  {
    icon: Gauge,
...
const faqs = [
  {
    ...
    answer:
      "RFL Agent can load completed draft data from connected Sleeper and ESPN fantasy football leagues. Available draft details can vary by platform and league format.",
  },
  {
