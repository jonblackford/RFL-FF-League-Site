...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Sleeper league data used by RFL Agent is available through Sleeper’s league APIs, so you can normally connect with a username or league ID without entering Sleeper account credentials.",
  },
  {
    question: "Does RFL Agent support dynasty and redraft leagues?",
    answer:
      "RFL Agent supports Sleeper NFL leagues across common redraft, keeper, and dynasty setups. Some analysis depends on the scoring, roster, schedule, and history data available for that specific league.",
  },
];
    ...
    <section class="border-y bg-muted/30">
      ...
      >
        <div>
          ...
          <p class="mt-4 leading-7 text-muted-foreground">
            Sleeper links renewed leagues from year to year. RFL Agent follows
